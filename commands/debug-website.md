...
Read skills/cinematic-web-design/references/visual-debug.md, then run the debug
command against the requested website. Open its screenshots with the available
